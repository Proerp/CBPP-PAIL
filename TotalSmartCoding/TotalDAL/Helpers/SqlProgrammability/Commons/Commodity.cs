...
namespace TotalDAL.Helpers.SqlProgrammability.Commons
{
    public class Commodity
    {
        ...
        private void ImportCommodities()
        {
            ...
            queryString = queryString + "           SELECT          ProductID AS CommodityID, ProductCode AS Code, ProductCodeOriginal AS OfficialCode, ProductName AS Name, ProductName AS OfficialName, 1 AS CommodityCategoryID, 1 AS CommodityTypeID, NULL AS Unit, N'1 x 1' AS PackageSize, NULL AS Origin, NULL AS APICode, IIF(IsPailLabel = 1, '5', '5') AS FillingLineIDs, 1 AS Volume, 1 AS Weight, NoItemPerCarton AS PackPerCarton, 30 AS CartonPerPallet, 1 AS PackageVolume, NoExpiryDate AS Shelflife, NULL AS Remarks, 0 AS Discontinue, 0 AS InActive " + "\r\n";
